...
define('DB_NAME', 'flowgame_banco');

/** MySQL database username */
define('DB_USER', 'flowgame_banco');

/** MySQL database password */
define('DB_PASSWORD', 'B3cd5L35jJId6gNy');
...
define('WP_SITEURL', isset($_SERVER['HTTP_HOST']) ? (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? 'https://'.$_SERVER['HTTP_HOST'] : 'http://'.$_SERVER['HTTP_HOST'] : 'http://flowgames.gg');
define('WP_HOME', isset($_SERVER['HTTP_HOST']) ? (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? 'https://'.$_SERVER['HTTP_HOST'] : 'http://'.$_SERVER['HTTP_HOST'] : 'http://flowgames.gg');
