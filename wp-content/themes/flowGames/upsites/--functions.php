...
{
  $check_page_news_exist = get_page_by_title('Notícias de Games', 'OBJECT', 'page');
  ...
  $check_page_videos_exist = get_page_by_title('Podcasts e Vídeos', 'OBJECT', 'page');
  // Check if the page already exists
  ...
  $check_page_webstories_exist = get_page_by_title('Webstories de Games', 'OBJECT', 'page');
  // Check if the page already exists
  ...
  $check_page_contact_exist = get_page_by_title('Contato', 'OBJECT', 'page');
  // Check if the page already exists
  ...
  $check_page_about_exist = get_page_by_title('Quem Somos', 'OBJECT', 'page');
  // Check if the page already exists
